...
Is this returning nothing or is it returning `foo()`? The parser will normally just think that it's the latter case, but that may not be true. So how do we fix this?
