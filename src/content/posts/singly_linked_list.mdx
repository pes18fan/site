...
So recently, I found this awesome video by [Low Level Learning](https://www.youtube.com/@LowLevelTV)
...
was written in C, however I wanted to be ✨*different*✨ and to use another language.
I picked Crystal, mainly because:
...
This was the start of a very interesting journey (should I even call it journey?
...
about how singly linked lists (I'll call them SLLs from here since the phrase is too long) work.

## humble beginnings

Everything began with the definition of a `struct` for a node. In a SLL, every 
